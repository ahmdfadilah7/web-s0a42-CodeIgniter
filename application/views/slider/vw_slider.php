        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="<?= base_url() ?>slider/tambah" class="btn btn-info mb-2"
                        data-toggle="modal" data-target="#modal-lg"><i class="fa fa-plus"></i> Tambah slider</a>
                            ...
                            <tbody>
                                ...
                                <tr id="<?= $us['id'] ?>">
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url('slider/edit/') . $us['id']; ?>"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Form Data slider</h4>
                ...
                <form method="POST" action="<?= base_url('slider/tambah');?>" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <button type="submit" name="tambah"
                            class="btn btn-primary float-right">Tambah slider</button>
                </form>
